...
class GuessGame:
    ...
    def hibelow50(self):
        if self.num > 25:
            self.var = ('the number is greater than 25\npoints: ' + str(self.points))
        elif self.num < 25:
            self.var = ('the number is 25 below\npoints: ' + str(self.points))
    ...
    def __init__(self, master):
        self.num = random.randint(1,50)
        self.points = 100
        self.var = ('Guess the number from 1 to 50')
        ...
        self.clearbutton.grid(row=6, column=0, columnspan=3, padx=10, pady=5, sticky=N+S+E+W) 
